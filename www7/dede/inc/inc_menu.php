...
<m:top item='1_10_7_' name='站长资源' display='none'>
  <m:item name='AB模板网' link='http://www.adminbuy.cn' rank='' target='_blank' />
  <m:item name='害羞网' link='http://www.henhaixiu.com' rank='' target='_blank' />
  <m:item name='神秘事件' link='http://www.92ufo.com/' rank='' target='_blank' />
  <m:item name='迅雷电影' link='http://www.yiquantou.com' rank='' target='_blank' />
  <m:item name='新埭论坛' link='http://www.xd11.com' rank='' target='_blank' />
</m:top>
