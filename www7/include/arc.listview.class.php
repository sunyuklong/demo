...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a href='".str_replace("{page}",$prepagenum,$tnamerule)."' class='a1' id='prevpage'>上一页</a>\r\n";
            $indexpage="<a href='".str_replace("{page}",1,$tnamerule)."' id='firstpage'>首页</a>\r\n";
        }
        else
        {
            $indexpage="<a href='#' class='disable' id='firstpage'>首页</a>\r\n";
        }

        //下一页,未页的链接
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<a href='".str_replace("{page}",$nextpagenum,$tnamerule)."' class='a1' id='nextpage'>下一页</a>\r\n";
            $endpage="<a href='".str_replace("{page}",$totalpage,$tnamerule)."' id='lastpage'>末页</a>\r\n";
        }
        else
        {
            $endpage="<a href='#' class='disable' id='lastpage'>末页</a>\r\n";
        }
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a href='".$purl."PageNo=$prepagenum' class='a1' id='prevpage'>上一页</a>\r\n";
            $indexpage="<a href='".$purl."PageNo=1' id='firstpage'>首页</a>\r\n";
        }
        else
        {
            $indexpage="<a class='disable' id='firstpage'>首页</a>\r\n";
        }
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<a href='".$purl."PageNo=$nextpagenum' class='a1' id='nextpage'>下一页</a>\r\n";
            $endpage="<a href='".$purl."PageNo=$totalpage' id='lastpage'>末页</a>\r\n";
        }
        else
        {
            $endpage="<a href='#' class='disable'id='lastpage'>末页</a>\r\n";
